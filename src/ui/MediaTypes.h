...
struct MediaInfo {
  ...
  MediaInfo()
      : type(MediaType::Photo), fileId(0), isDownloading(false), width(0),
        height(0), thumbnailFileId(0), duration(0) {}
};
...
struct MediaSpan {
  ...
  MediaSpan()
      : startPos(0), endPos(0), messageId(0), fileId(0), thumbnailFileId(0),
        type(MediaType::Photo), width(0), height(0) {}
};
